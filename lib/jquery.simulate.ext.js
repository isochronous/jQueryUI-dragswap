define([
    ...
    (function ($) {
         ...
         * @param {element} ele - the object/element to be tested
        ...
        function windowOfDocument(doc) {
            for (var i = 0; i < window.frames.length; i += 1) {
                try {
                    ...
                    // frame we don't have access to (like facebook, maybe). Don't worry about it.
                }
            }
            return window;
        }
        ...
        // Based on the findCenterNoScroll function from jquery.simulate.js
        /**
         * Calculates the position of the center of an DOM element.
         * @param {element} elem - the element whose center should be calculated.
         ...
         * @since 1.0
         */
        function findCenterNoScroll(elem) {
            var offset,
                $elem = $(elem);
            if (isDocument($elem[0])) {
                offset = {left: 0, top: 0};
         ...
         * @param {number|Object} x - Either the x coordinate of the page relative coordinates or
         * an object with the properties <code>pageX</code> and <code>pageY</code> representing page
         * relative coordinates.
         * @param {number} [y] - If <i>x</i> is numeric (i.e. the x coordinate of page relative coordinates),
         * then this is the y coordinate. If <i>x</i> is an object, this parameter is skipped.
         * @param {document} [docRel] - Optional DOM document object used to calculate the client relative
         ...
         *
         * @param {number|Object} x - Either the x coordinate of client relative coordinates or an object
         * with the properties <code>x</code> and <code>y</code> representing client relative coordinates.
         * @param {number} [y] - If <i>x</i> is numeric (i.e. the x coordinate of client relative coordinates),
         * this is the y coordinate. If <i>x</i> is an object, this parameter is skipped.
         * @param {document} [docRel] - Optional DOM document object
         ...
         * @param {element} ele - The element which was dragged.
         ...
         * @param {element} ele - The element which is dragged.
             ...
             */
            {
                ...
                simulateDrag: function () {
                    ...
                    if (options.dragTarget) {
                        var end = findCenterNoScroll(options.dragTarget);
                ...
                simulateDrop: function () {
                    var self = this,
                        ...
                        moveBeforeDrop = true,
                        center = findCenterNoScroll(ele),
                        x = Math.round(center.x),
                        y = Math.round(center.y),
                        coord = { pageX: x, pageY: y },
                        targetDoc = ( (activeDrag) ? selectFirstMatch([activeDrag.dragElement, activeDrag.dragElement.ownerDocument], isDocument) :
                            selectFirstMatch([ele, ele.ownerDocument], isDocument) ) || document,
                        clientCoord = pageToClientPos(coord, targetDoc),
